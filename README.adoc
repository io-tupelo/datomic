...
= Tupelo Datomic: Making Datomic Even Sweeter

=== image:https://img.shields.io/clojars/v/io.tupelo/datomic.svg[link="https://clojars.org/io.tupelo/datomic"]  <= Current Version (click for dep string)

=== The https://cloojure.github.io/doc/io-tupelo-datomic/[Tupelo-Datomic API Docs] are on GitHub Pages
...
- Download Datomic Free from:  https://my.datomic.com/downloads/free
- Unpack the zip file, and view the README
- chmod a+x bin/maven-install
- bin/maven-install
- add the coordinates to your lein project, like:   [com.datomic/datomic-free "0.9.5703.21"]
...
Copyright © 2015-2020  Alan Thompson
